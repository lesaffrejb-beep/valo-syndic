    ...
    return (
        <div className={`flex items-center bg-surface-highlight border border-boundary rounded-lg p-1 ${className}`}>
            <button
                ...
                disabled={value <= min}
                className="w-8 h-8 flex items-center justify-center rounded-md text-muted hover:text-main hover:bg-surface disabled:opacity-30 disabled:hover:bg-transparent transition-colors"
                aria-label="Diminuer"
            >
            ...
            <div className="flex items-center px-1">
                <input
                    ...
                    onBlur={handleBlur}
                    className="w-12 text-center bg-transparent border-none outline-none text-main font-bold p-0 text-sm appearance-none focus:ring-0"
